...
Page({
  ...
  initGoodsDetailData(data) {
    ...
    // 商品价格/划线价/库存
    data.goods_sku_id = data.detail.goods_sku_id;
    data.goods_price = data.detail.goods_price;
    data.line_price = data.detail.line_price;
    data.stock_num = data.detail.stock_num;
    // 初始化商品多规格
