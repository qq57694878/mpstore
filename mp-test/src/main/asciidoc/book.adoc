...
.request
include::{snippets}/OrcControllerTest/getappocrinfo/http-request.adoc[]

.response
include::{snippets}/OrcControllerTest/getappocrinfo/http-response.adoc[]
...
.request
include::{snippets}/UploadControllerTest/list/http-request.adoc[]

.response
include::{snippets}/UploadControllerTest/list/http-response.adoc[]
